...
const detailsModalOld = `      {systemDetailsModal && (
...
if (app.includes(detailsModalOld)) {
  app = app.replace(detailsModalOld, detailsModalNew);
} else {
  console.log("Could not find detailsModalOld exactly!");
}
