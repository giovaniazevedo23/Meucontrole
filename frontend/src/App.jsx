                ...
                {loginMode === 'login' && (
                  <>
                    ...
                    <div className="form-group" style={{ marginBottom: '1.5rem', position: 'relative' }}>
                        ...
                        />
                        <button type="button" onClick={() => setShowPassword(!showPassword)} style={{ position: 'absolute', right: '10px', top: '40px', background: 'none', border: 'none', cursor: 'pointer', fontSize: '1.2rem' }}>
