...
// Splice modal logic FIRST (higher line numbers)
lines.splice(2768, 2792 - 2768 + 1, detailsModalNew);
...
// Splice search logic (lower line numbers)
lines.splice(2708, 2716 - 2708 + 1, searchLogicNew);
